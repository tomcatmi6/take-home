  ...
  return (
    ...
    >
      ...
      {description && (
        <p
          id={`card-desc-${title}`}
          className={`text-sm card-description ${isExpanded ? "expanded" : ""}`}
        >
          {description}
        </p>
      )}
